/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+docker+git+go+graphql+java+json+kotlin+less+markup-templating+php+python+jsx+tsx+scss+sql+swift+typescript */
var _self =
