/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+docker+git+java+json+json5+kotlin+markup-templating+php+python+jsx+tsx+scss+sql+typescript+yaml */
