  ...
  return (
    <article className="h-auto w-full py-6 lg:py-12">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        Slog(이하 &quot;사이트&quot;) 는 「개인정보 보호법」 제30조에 따라
      ...
      <ul>
        <li className="pl-4 leading-7">
          사이트 회원가입 및 관리 회원 가입의사 확인, 회원제 서비스 제공에 따른
          본인 식별·인증 목적으로 개인정보를 처리합니다.
        </li>
      </ul>
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        사이트는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <ul>
        <li className="pl-4 leading-7">
          파기 사유가 발생한 개인정보를 선정하고 즉시 파기합니다.
        </li>
      </ul>
      ...
      <ul>
        <li className="pl-4 leading-7">
          개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여, 변경을
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        1) 사이트는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
      ...
      <ul>
        ...
        <li className="mt-3 pl-4 leading-7">
          나. 쿠키의 설치 및 운영 및 거부 : 웹브라우저 상단의 도구&gt;인터넷
