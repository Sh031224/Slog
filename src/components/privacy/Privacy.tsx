    ...
    <PrivacyWrapper>
      <PrivacyContainer>
        ...
        <ul>
          ...
          <li>
            제공받는 자의 개인정보 이용목적 : 이름, 서비스 이용 기록, 접속 IP 정보, Facebook user id
          </li>
          <li>제공받는 자의 보유.이용기간: 영구</li>
        </ul>
        <p>
          ③ <span>{"<Slog>('https://slog.website/'이하 'Slog')"}</span>
          은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보
        ...
        <ul>
          <li>{"1 <차승호>"}</li>
          <li>필수항목 : 이름, 서비스 이용 기록, 접속 IP 정보, Facebook user id</li>
        </ul>
        <br />
        <br />
        <p>
        ...
        <p>
          ...
          개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할
        ...
        <em>{"<Slog>('Slog')"}</em>
        은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적
        조치를 하고 있습니다.
        <p>
          1. 해킹 등에 대비한 기술적 대책
          <br /> {"<"}
          ...
          {"('"}
          <em>Slog</em>
          {"')"}은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여
